...
public class QM_CharController : MonoBehaviour
{
    ...
    private float deltaGround = 0.5f; // character is grounded up to this distance
    private float jumpSpeed = 6; // vertical jump initial speed
    private float jumpRange = 16; // range to detect target wall
